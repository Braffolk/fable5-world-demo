...
1. `docs/tasks/2026-07-21/GRASS-EXACT-REPRESENTATION-THEORY.md` — **the
...
2. `docs/tasks/2026-07-22/GRASS-SHELL-FRAME-FIELD.md` — §14 first (**why
...
3. `docs/tasks/2026-07-22/GRASS-SHELL-FRAME-FIELD-RECONSTRUCTION-BLOCKER.md`
   and `...-RED-BLOCKER.md` — what failed and why, so you do not rebuild it.
4. `docs/tasks/2026-07-21/GRASS-STATUS-AND-ISSUES.md` §§18–44 — the rejection
...
- **Dual task tracking:** the Claude Code tasklist tool **and** dated files
  under `docs/tasks/2026-07-22/`, kept in sync, updated at every terminal
