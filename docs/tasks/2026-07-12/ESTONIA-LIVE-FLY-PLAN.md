...
| 115 | Smooth FAR water edges (waterFar min-reduce) — follow-up to #114 | ⏳ QUEUED | far water keeps ×8 min-reduced `waterFar` (sinks surface + depth-culls edge whole-cell) → coverage mask can't fix without reworking waterFar. α ships LOD0+LOD1 already. Surfaced by #114 agent. |
