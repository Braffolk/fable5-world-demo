...
- Reusable result: the executable, exact cost table, complete metrics, hashes,
  ...
  `docs/tasks/2026-07-21/GRASS-FIXED-K-EVENT-RECORD-FEASIBILITY.md`; provenance
...
- The preserved adversarial report is
  `GRASS-LINE-INVARIANT-TRANSFER-FIELD-AUDIT.md`. The expensive actual-mesh beam
...
- Reusable result: `270,535` real primitive-instance charts, all contiguous in
  ...
  The full report is `GRASS-PROCEDURAL-CHART-FEASIBILITY.md`; source provenance
...
- Full report and QA:
  `GRASS-PACKED-LIGHT-FIELD-FALLBACK-GATE.md`; immutable provenance is
...
- Full report:
  `GRASS-COUPLED-BANDLIMITED-EVENT-SHEET-FEASIBILITY.md`. Artifact:
...
- Full math, source boundary, hashes, metrics, and numbered QA are in
  `GRASS-PLENOPTIC-SAMPLING-CASCADE-GATE.md`; Experiment 014 in the central
...
- The math is exact for that class. After inverse affine transport, finite slab
  ...
  all recorded in `GRASS-FOUR-AFFINE-SLAB-EXTRUSION-FEASIBILITY.md`.
...
- Full proof boundary, primary-source ancestry, metrics, tool/hash provenance,
  and numbered QA are in `GRASS-ANGULAR-EVENT-FLOW-CEILING.md`; Experiment 016
...
- Full proof, immutable source hashes, prior-art boundary, cost, and resume
  condition are in `GRASS-FINITE-SWEPT-FIBRE-FEASIBILITY.md`; Experiment 017 is
...
- Full math, measured table, cost, tool and report hashes are in
  `GRASS-CELL-EXIT-POINTED-LINE-FACTORIZATION.md`. Artifact:
...
- Full equations, costs, acceptance tests and primary-source/contribution
  boundaries are in `GRASS-HYBRID-DEEP-TRANSFER-FACTORIZATION.md`; Experiment
...
- Decision: **reject and park.** Do not add another inverse iteration, direction
  ...
  `GRASS-PROJECTIVE-INVERSE-CORRESPONDENCE-GATE.md`; artifact:
...
- Decision: **reject before f16/table sampling.** Encoding a known-wrong
  ...
  and result are in `GRASS-PAIRWISE-PLANE-TRANSFER-GATE.md`; report and numbered
  QA live under
...
- Decision: **reject and park after the single allowed actual-source attempt.**
  ...
  `GRASS-FRAME-GLOBAL-PINHOLE-LIGHT-FIELD-GATE.md`; artifact:
...
- Full proof, metrics, provenance, and implementation boundary are in
  `GRASS-FOUR-VIEW-HIT-HEIGHT-GATE.md`; Experiment 023 in the central ledger;
  artifact:
...
- Decision: **reject as the complete grass representation.** Preserve the
  ...
  `GRASS-DIRECT-RADIANCE-FIELD-GATE.md`; Experiment 024 in the central ledger;
  artifact:
...
- Decision: **reject and park.** Do not loosen support (which restores the
  ...
  `GRASS-SUPPORT-BOUNDED-CANONICAL-PLANE-GATE.md`; Experiment 025 in the central
  ledger; artifact:
...
- Dense artifact:
  ...
  `docs/tasks/2026-07-22/GRASS-SHELL-FRAME-FIELD-RECONSTRUCTION-BLOCKER.md`.
...
- Binding documents:
  `docs/tasks/2026-07-22/CLASS-E-MATHEMATICAL-AUDIT.md` (why the inherited
  theory is RED) and
  `docs/tasks/2026-07-22/CLASS-E-EXTERIOR-MATHEMATICAL-SPEC.md` (corrected
  exterior-only theorem, bounds, counterexamples, cost equations, and gate
  order). The old `GRASS-EXACT-REPRESENTATION-THEORY.md` construction is marked
  superseded.
...
- Decision: **do not implement the Class-E `M x I` runtime.** Return to the
  ...
  `docs/tasks/2026-07-22/CLASS-E-CPU-GATE-RESULT.md`; final artifact:
...
- Full report:
  `docs/tasks/2026-07-22/GRASS-LATERAL-CORE-RESIDUAL-CPU-GATE.md`.
...
- Solver design, catalogue/tail conditions, lower-bound ladder, estimated
  ...
  `docs/tasks/2026-07-23/GRASS-JOINT-K2K2-GLOBAL-OPTIMIZATION.md`.
...
- Full derivation, metrics, hashes, QA paths, waste record, and resume condition:
  `docs/tasks/2026-07-23/GRASS-INVERSE-AUTHORED-FOUR-FIELD-MATH.md`. F6 artifact:
...
- Full proof: `docs/tasks/2026-07-23/GRASS-PACKED-INTERVAL-RELAY-MATH.md`.
...
- Full proof: `docs/tasks/2026-07-23/GRASS-STRATIFIED-SPECTRAL-HEAD-MATH.md`.
...
- The corrected boundary and exact resume conditions are in
  `docs/tasks/2026-07-23/GRASS-EXTERIOR-VISIBILITY-COMPLEX-MATH.md`.
...
- Consolidated proof and contract:
  `docs/tasks/2026-07-23/GRASS-COMPLETE-MODEL-BOUNDARY.md`.
...
- Binding documents:
  ...
  `docs/tasks/2026-07-23/GRASS-BOUNDARY-TRANSFER-FINITE-CODEC.md`, and
...
- Binding gate:
  `docs/tasks/2026-07-23/GRASS-BOX-BOUNDARY-TRANSFER-CPU-GATE.md`.
